...
## Current iPhones
Maximum bending stress is independent of material^[I imagine a titanium vs aluminum frame matters a fair bit.], and the dimensions of the pro/non-pro phones are close enought to combine the calculations.
...
$148.6mm \times 71.5mm \times 8mm = 0.1486m \times 0.0715m \times 0.008m$^[Converting mm to m makes the numbers less pretty but means we don't need to worry about units.]

For a force P at the midpoint of the base iPhone, the peak moment is:  
$$M_{\text{max}} = \frac{P\times0.1486m}{4} = 0.03715m \times P$$  
Bending stress is calculated using $σ_{\text{max}} = \frac{M}{S}$. With $M$ the moment and $S$ the section modulus. This value is dependent on the shape of the cross section of the beam. In this case a rectangle and equals $S = \frac{b \times h^2}{6}$^[in engineering, b (base) is used for width]. For our average iPhone that means:  
...
$$M_{\text{max}} = \frac{P \times 0.162m}{4} = 0.0405m  \times  P$$  The section modulus:  
...
$$σ_{\text{max}} = \frac{M}{S} = \frac{0.0405m  \times  P}{0.000000763m^3} \approx 5.31  \times  10^4 m^{-2}  \times  P$$  $$4.89  \times  1.1 = 5.38 \approx 5.31$$  
