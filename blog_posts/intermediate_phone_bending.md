...
\\(148.6mm \times 71.5mm \times 8mm\\)

For a force \\(P\\) at the midpoint of the base iPhone, the peak moment is:  
\\[M_{\text{max}} = \frac{P\times148.6mm}{4} = 37.15mm \times P\\]  
...
\\[S = \frac{b \times h^2}{6} = \frac{71.5mm \times 8^2mm^2}{6} \approx 763mm^3\\]  
With our maximum bending stress coming to:  
\\[σ_{\text{max}} = \frac{M}{S} = \frac{37.15mm  \times  P}{763mm^3} \approx 4.87  \times  10^{-2} mm^{-2}  \times  P\\]    
...
For our calculations:  
\\(162mm \times 77.7mm \times 8mm \\)  

Analogous to the previous section we can calculate the peak moment:  
\\[M_{\text{max}} = \frac{P \times 162mm}{4} = 40.5mm  \times  P\\]  
The section modulus:  
\\[S = \frac{b \times h^2}{6} = \frac{77.7mm \times 8^2 mm^2}{6} \approx 829mm^3\\]  
And the maximum bending stress:  
\\[σ_{\text{max}} = \frac{M}{S} = \frac{40.5mm  \times  P}{829mm^3} \approx 4.89  \times  10^{-2} mm^{-2}  \times  P\\]  
...
\\[σ_{\text{max}} = \frac{M}{S} = \frac{40.5mm  \times  P}{763mm^3} \approx 5.31  \times  10^{-2} m^{-2}  \times  P\\]  
\\[4.89  \times  1.1 = 5.38 \approx 5.31\\]  

## iPhone Air  
Dimensions (\\(h \times w \times d\\)):  
Air: \\(160.9mm \times 77.8mm \times 5.5mm\\)  
...
Analogous to the previous section we can calculate the peak moment:  
\\[M_{\text{max}} = \frac{P \times 160.9mm}{4} = 40.2mm  \times  P\\]  
...
\\[S = \frac{b \times h^2}{6} = \frac{71.5mm \times 5.5^2mm^2}{6} \approx 361mm^3\\]  
And the maximum bending stress:  
\\[σ_{\text{max}} = \frac{M}{S} = \frac{40.2mm  \times  P}{361mm^3} \approx 11.1  \times  10^{-2} mm^{-2}  \times  P\\]  

Compared to the current phones:
...
_edit 20/3/2025: Incorporated Dr. Drang's feedback on this post._
